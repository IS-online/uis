<div class="clearfix hidden-print " >
    <div class="easy-link-menu align-left">
        <a class="{!! request()->is('setting/general')?'btn-success':'btn-primary' !!} btn-sm " href="{{ route('setting.general') }}"><i class="fa fa-cog" aria-hidden="true"></i>&nbsp;Generalne postavke</a>
        <a class="{!! request()->is('setting/online-registration')?'btn-success':'btn-primary' !!} btn-sm " href="{{ route('setting.online-registration') }}"><i class="fa fa-archive" aria-hidden="true"></i>&nbsp;Online Registracija</a>
        ...
        <a class="{!! request()->is('setting/meeting')?'btn-success':'btn-primary' !!} btn-sm " href="{{ route('setting.meeting') }}"><i class="fa fa-video-camera" aria-hidden="true"></i>&nbsp; Sastanak - online nasatava</a>
