<h4 class="header large lighter blue"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;Upravljanje postavkama upozorenja</h4>
<div class="form-group">
    {!! Form::label('event', 'Događaj', ['class' => 'col-sm-1 control-label']) !!}
    <div class="col-sm-5">
    ...
    {!! Form::label('Type', 'Tip upozorenja', ['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-4">
...
<div class="form-group">
    {!! Form::label('subject', 'Predmet', ['class' => 'col-sm-1 control-label']) !!}
    <div class="col-sm-10">
...
<div class="form-group">
    {!! Form::label('template', 'Predložak', ['class' => 'col-sm-1 control-label']) !!}
    <div class="col-sm-10">
