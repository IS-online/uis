<div class="widget-box transparent" id="recent-box">
    <div class="widget-header">
        <h4 class="widget-title lighter smaller">
            <i class="ace-icon fa fa-book blue"></i>Biblioteka
        </h4>

        <div class="widget-toolbar no-border">
            <ul class="nav nav-tabs" id="recent-tab">
                <li class="active">
                    <a data-toggle="tab" href="#issue-tab">Izdavanje knjiga</a>
                </li>

                <li>
                    <a data-toggle="tab" href="#returnOver-tab">
                    Period povratka je završen <span class="badge badge-warning"> {{ $data['book_return_over']->count() }}</span>
                    </a>
                </li>
            </ul>
        </div>
