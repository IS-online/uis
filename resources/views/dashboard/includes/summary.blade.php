    ...
    <div class="widget-body">
        <div class="widget-main no-padding">
            <table class="table table-bordered table-striped">
                ...
                <tr>
                    <th colspan="2"> <i class="ace-icon fa fa-users green"></i>Status studenta
                    </th>
                </tr>
                </thead>
                ...
                @if (isset($data['student_active_status']) && $data['student_active_status']->count() > 0)
                    ...
                    @endforeach
                    <tr>
                        <td><b class="blue">Ukupno studenata:</b></td>
            ...
            <table class="table table-bordered table-striped">
                <thead class="thin-border-bottom">
                <tr>
                    <th colspan="2"> <i class="ace-icon fa fa-users blue"></i>Akademski status
                    </th>
                </tr>
                </thead>
    ...
    <div class="widget-body">
        <div class="widget-main no-padding">
            <table class="table table-bordered table-striped">
                <thead class="thin-border-bottom">
                <tr>
                    <th colspan="2"> <i class="ace-icon fa fa-user-secret green"></i>Status uposlenika
                    </th>
                </tr>
                </thead>
                ...
                @if (isset($data['staff_status']) && $data['staff_status']->count() > 0)
                    ...
                    @endforeach
                    <tr>
                        <td><b class="blue">Ukupno uposlenika:</b></td>
    ...
    <div class="widget-body">
        <div class="widget-main no-padding">
            <table class="table table-bordered table-striped">
                <thead class="thin-border-bottom">
                <tr>
                    <th colspan="2"> <i class="ace-icon fa fa-book green"></i>Status knjige
                    </th>
                </tr>
                </thead>
                ...
                @if (isset($data['books_status']) && $data['books_status']->count() > 0)
                    ...
                    @endforeach
                    <tr>
                        <td><b class="blue">Ukupno knjiga:</b></td>
