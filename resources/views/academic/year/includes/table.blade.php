                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($year->active_status == 1)
                                            <div class="btn-group">
                                                <label class="label label-primary">Aktivna godina</label>
                                            </div>
                                        @else
                                            <div class="btn-group">
                                                <a href="{{ route($base_route.'.active-status', ['id' => $year->id]) }}">
                                                    <i class="fa fa-check" aria-hidden="true"></i> Klikni da aktiviraš godinu
                                                </a>
                                            </div>
                                        @endif
                                    </td>
                                    <td>
                                        <div class="btn-group">
                                            <button data-toggle="dropdown" class="btn btn-primary btn-minier dropdown-toggle {{ $year->status == 'active'?"btn-info":"btn-warning" }}" >
                                                {{ $year->status == 'active'?"Aktivna":"Neaktivna" }}
