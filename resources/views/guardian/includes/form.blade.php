{{--
    <h4 class="header large lighter blue"><i class="fa fa-search" aria-hidden="true"></i>&nbsp;Pretraži mentore</h4>
                ...
                {!! Form::open(['route' => $base_route,'method' => 'GET', 'class' => 'form-horizontal',
                    ...
                    <div class="clearfix">
                        <div class="form-group">
                            {!! Form::label('q', 'Pretraga pomoću: imena | broj mobitela | Email-Id', ['class' => 'col-sm-4 control-label']) !!}
                            <div class="col-sm-8">
