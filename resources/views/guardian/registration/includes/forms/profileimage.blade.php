<h4 class="header large lighter blue"><i class="ace-icon glyphicon glyphicon-plus"></i>Profilna slika</h4>
<div class="form-group">
    {!! Form::label('guardian_main_image', 'Slika mentora', ['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-6">
