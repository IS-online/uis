...
<div class="form-horizontal">
        ...
        <div class=" col-sm-2">
            ...
            <div class="col-sm-2">
                <select name="semesters_id" class="form-control semesters_id" onChange="loadSubject(this)" >
                    <option value="0"> Odaberi Sem./Sec. </option>
                </select>
            </div>
    </div>

    <div class="form-group">
        <label class="col-sm-1 control-label">Predmet/Subject</label>
        <div class="col-sm-6">
            <select name="subjects_id" class="form-control semester_subject"  onChange ="loadStudent(this)">
                <option value="0"> Odaberi predmet </option>
            </select>
        </div>
    ...
    <div class="form-group">
        <label class="col-sm-1 control-label">Grupa</label>
        <div class="col-sm-11">
            {!! Form::select('batch', $data['batch'], null, ['class' => 'form-control' , 'onChange' => 'loadStudent(this);']) !!}
            <em>Odaberite Samo ako želite da filtrirate grupno</em>
        </div>
