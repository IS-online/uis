                         ...
                         {!! Form::open(['route' => $base_route.'.store', 'method' => 'POST', 'class' => 'form-horizontal',
                            ...
                            <div class="form-group">
                                ...
                                <label class="pos-rel">
                                    ...
                                    <span class="lbl"></span> <span class="label label-info" >Pošalji upozorenje o prisustvu svima </span>
                                </label>

                                <label class="pos-rel">
                                    {!! Form::radio('send_alert', 2, false, ['class' => 'ace', "required"]) !!}
                                    <span class="lbl"></span> <span class="label label-danger" >Pošalji obavještenje o odsutnosti </span>
                                </label>

                                <label class="pos-rel">
                                    {!! Form::radio('send_alert', 3, false, ['class' => 'ace', "required"]) !!}
                                    <span class="lbl"></span> <span class="label label-danger" >Pošalji upozorenje o odsutnosti mentoru</span>
                                </label>

                                <label class="pos-rel">
                                    {!! Form::radio('send_alert', 0, true, ['class' => 'ace', "required"]) !!}
                                    <span class="lbl"></span> <span class="label label-warning" >Upozorenje nije potrebno</span>
                                </label>

                            </div>
                                <label class="pos-rel">
                                    <span class="lbl"></span> <span class="label label-success" >
                                    Ako želite poslati upozorenje o odsutnosti mentoru, uključite broj mentora STAFF_ABSENT_NOTIFICATION_HEAD_NUMBERS Variabla u .env
                                        </span>
                                </label>
