                ...
                <div class="row">
                    <div class="col-xs-12 ">
                        ...
                        <div class="col-md-12 col-xs-12">
                            <h4 class="header large lighter blue"><i class="fa fa-search" aria-hidden="true"></i>&nbsp;Kreiraj {{ $panel }}</h4>
                            <!-- PAGE CONTENT BEGINS -->
                            ...
                            {{--<div class="alert alert-warning alert-dismissible" role="alert">
                                ...
                                Info: Molim da, odaberete Fakultet/Odsjek, Sem./Sec. i predmet za dozvolu pristupa preuzimanju. U suprotnom, prikazuje se svim korisnicima.
                            </div>--}}
