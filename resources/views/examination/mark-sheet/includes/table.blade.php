...
{!! Form::open(['route' => 'print-out.exam.mark-sheet', 'id' => 'print-student-marksheet']) !!}
    ...
    <div class="clearfix">
        <label class="pos-rel">
            ...
            <span class="lbl"></span> Ocjenjivanje
        </label>
        <label class="pos-rel">
            <input type="radio" name="result-type" value="percentage" id="typePercentage" class="ace" />
            <span class="lbl"></span> Procenat
        </label>
        <label class="pos-rel">
            <input type="radio" name="result-type" value="ledger" id="typeLedger" class="ace" />
            <span class="lbl"></span> Ledger
        </label>
        <a type="submit" class="btn-primary btn-sm print-marksheets" ><i class="fa fa-print" aria-hidden="true"></i>&nbsp; Ispis postignutih rezultata</a>
        <span class="pull-right tableTools-container"></span>
    </div>
    <div class="table-header">
        Pregled ispita u tabeli. Filtrirajte ispite pomoću filtra..
    </div>
    ...
    <div class="table-responsive">
        ...
        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    ...
                    @else
                        <tr>
                            <td colspan="4">Nisu pronađeni podaci o ispitima. Filtrirajte ispite za prikaz. </td>
                        </tr>
                    @endif
                </tbody>
            </table>
