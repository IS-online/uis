...
@section('js')
    ...
    <script>
        $(document).ready(function () {
            $('.print-marksheets').click(function () {
                ...
                if($grading || $percentage || $ledger){
                    ...
                    if($chkCount <= 0){
                        toastr.info("Odaberite barem jedan zapis.","Info:");
                        return false;
                    }
                    ...
                    toastr.info("Označite što želite štampati: Ocjenjivanje, Procenat ili Ledger","Info:");
                    return false;
                }
        ...
        function loadSemesters($this) {
            ...
            if (month == 0) {
                toastr.info("Odaberite mjesec", "Info:");
                return false;
            }

            if (exam == 0) {
                toastr.info("Odaberite vrstu ispita", "Info:");
                return false;
            }

            if (faculty == 0) {
                toastr.info("Odaberite fakultet/odsjek", "Info:");
                return false;
            }
        ...
        function loadStudent($this) {
            ...
            if (year !== 0) {
                ...
                toastr.info('Odaberite godinu','Info:');
                return false;
            }
            ...
            if (exam !== 0) {
                ...
                toastr.info('Odaberite Raspored ispita','Info:');
                return false;
            }
            ...
            if (semester !== 0) {
                ...
                toastr.info('Odaberite Sem./Sec.','Info:');
                return false;
            }
            ...
            if(flag == true){
                ...
                toastr.info("Odaberite svoj ciljni raspored", "Info:");
                return false;
            }
