        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb0">
                <div class="form-horizontal">
                    <div class="box-body">
                        ...
                        <input type="hidden" name="user_type" id="userType" value="2"/>
                        <div class="form-group">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Relacija</label>
                                    <div class="col-sm-9">
                                        {!! Form::select('route_assign', $data['routes'], null, ['class' => 'form-control', "onChange" => "loadVehicle(this)"]) !!}
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Vozilo</label>
                                    <div class="col-sm-9">
            ...
            <div class="modal-footer">
                <div class="box-body">
                    ...
                    <button type="submit" class="btn cfees save_button btn-success" id="renew-btn" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"> <i class="fa fa-car" aria-hidden="true"></i> Dodijeli prijevoz </button>
                </div>
            </div>
        </div>
        {!! Form::close() !!}
