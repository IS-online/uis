...
<div class="row">
    ...
    {{--create--}}
    <div class="col-xs-12">
        <h4 class="header large lighter blue"><i class="fa fa-key" aria-hidden="true"></i>&nbsp;Kreirajte pristup za prijavu uposlenih</h4>
    ...
    {{--edit--}}
    <div class="col-xs-12">
        <h4 class="header large lighter blue"><i class="fa fa-key" aria-hidden="true"></i>&nbsp;Uredi pristup za prijavu uposlenika</h4>
        <a href="{{ route('staff.user.active', ['id' => $data['staff_login']->id]) }}" title="Active" class="btn-success btn-sm"><i class="fa fa-unlock-alt" aria-hidden="true"></i> Otključaj korisnika</a>
        <a href="{{ route('staff.user.in-active', ['id' => $data['staff_login']->id]) }}" title="In-Active" class="btn-warning btn-sm"><i class="fa fa-lock" aria-hidden="true"></i> Zaključaj korisnika</a>
        <a href="{{ route('staff.user.delete', ['id' => $data['staff_login']->id]) }}" title="Delete" class="btn-danger btn-sm"><i class="fa fa-trash" aria-hidden="true"></i> Izbriši korisnika</a>
        <div class="hr hr-24"></div>
        ...
        <div class="col-sm-4">
            <label data-toggle="dropdown" class="label {{ $data['staff_login']->status == 'active'?"label-success":"label-danger" }}" >
                {{ $data['staff_login']->status == 'active'?"Korisnik je aktivan":"Korisnik je zaključan" }}
            </label>
        </div>
