<div class="row">
    <div class="col-xs-12">
        <h4 class="header large lighter blue"><i class="fa fa-list" aria-hidden="true"></i>&nbsp;Pregled prisutnosti</h4>
        <div class="clearfix">
            <span class="pull-right tableTools-container"></span>
        </div>
        <div class="table-header">
            Evidencije o prisustvu osoblja u tabeli. Filtrirajte listu koristeći polje za pretragu po želji.
        </div>
        ...
        <div class="table-responsive">
            <table id="" class="table table-striped table-bordered table-hover dynamic-table">
                ...
                @else
                    <tr>
                        <td colspan="35"  class="align-left">Podaci o prisustvu nisu pronađeni.</td>
                    </tr>
                @endif
                </tbody>
            </table>
