<div class="row">
    <div class="col-xs-12">
        <h4 class="header large lighter blue"><i class="fa fa-list" aria-hidden="true"></i> Status u biblioteci</h4>
        <div class="clearfix easy-link-menu">
            <span>
                @if($data['lib_member'])
                    <a class="btn-primary btn-sm" href="{{ route('library.staff.view', ['id' => $data['lib_member']->member_id]) }}">
                         <i class="fa fa-calculator" aria-hidden="true"></i> Status u biblioteci
                    </a>
                @endif
            </span>
        </div>
        ...
        <div class="table-header">
            Tabelarni prikaz osoblja koje koristi usluge biblioteke. Filtrirajte listu koristeći polje za pretragu po želji.
        </div>
        ...
        <div class="table-responsive">
            <table id="" class="table table-striped table-bordered table-hover dynamic-table">
                ...
                @else
                    <tr>
                        <td colspan="10">Pregled izdanih knjiga nije pronađen.</td>
                        </td>
                    </tr>
                @endif
                </tbody>
