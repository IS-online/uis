                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="align-right">
                            <a class="{!! request()->is('staff/import*')?'btn-success':'btn-primary' !!} btn-sm" href="{{ route('staff.import') }}"><i class="fa fa-upload" aria-hidden="true"></i>&nbsp;Grupna registracija uposlenika</a>
                        </div>
