<div class="form-group">
    {!! Form::label('reg_no', 'Reg. br.', ['class' => 'col-sm-4 control-label']) !!}
    <div class="col-sm-8">
...
<div class="form-group">
    {!! Form::label('title', 'Naslov', ['class' => 'col-sm-4 control-label']) !!}
    <div class="col-sm-8">
...
<div class="form-group">
    {!! Form::label('document_file', 'Odaberi fajl', ['class' => 'col-sm-4 control-label']) !!}
    <div class="col-sm-8">
...
@if (isset($data['row']))
    ...
    <div class="form-group">
        {!! Form::label('old_file', 'Stari fajl', ['class' => 'col-sm-4 control-label']) !!}
        <div class="col-sm-8">
            @if ($data['row']->file)
