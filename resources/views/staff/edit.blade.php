                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="align-right hidden-print">
                            <a class="btn-primary btn-sm" href="{{ route($base_route.'.view', ['id' => $data['row']->id]) }}"  >
                                <i class="ace-icon fa fa-eye"></i> Pogledaj profil uposlenika
                            </a>
                        </div>
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (data.error) {
                        ...
                        $('.semester_select').html('').append('<option value="0">Odaberi semestar.</option>');
        ...
        $(document).ready(function () {
            jqueryValidation(
                ...
                },
                {
                    ...
                    "date_of_birth": {
                        required: "Popunite datum rođenja",
                    },
                    "gender": {
                        required: "Odaberite Spol",
                    },
                    "nationality": {
                        required: "Ispunite državljanstvo",
                    },
                    "religion": {
                        required: "Fill Religion",
                    },
                    "permanent_place": {
                        required: "Popunite mjesto",
                    },
                    "permanent_district": {
                        required: "Popunite okrug/kanton",
                    },
                    "permanent_zone": {
                        required: "Fill  Zone",
                    },
