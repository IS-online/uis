<div class="row">
    <div class="col-xs-12">
        <h4 class="header large lighter blue"><i class="fa fa-list" aria-hidden="true"></i>&nbsp;Pregled studenata</h4>
        <div class="clearfix">
        <span class="easy-link-menu">
            ...
            <a class="btn-primary btn-sm bulk-action-btn" attr-action-type="create-reset-library-member"><i class="fa fa-book" aria-hidden="true"></i>&nbsp;Učlani u biblioteku</a>
        </span>
            <span class="pull-right tableTools-container"></span>
        </div>
        <div class="table-header">
            Tabelarni prikaz studenata. Filtrirajte za pretragu.
        </div>
        ...
        <div class="table-responsive">
            ...
            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="{{ route($base_route.'.active', ['id' => $student->id]) }}" title="Active"><i class="fa fa-check" aria-hidden="true"></i> Aktivan</a>
                                        </li>

                                        <li>
                                            <a href="{{ route($base_route.'.in-active', ['id' => $student->id]) }}" title="In-Active"><i class="fa fa-remove" aria-hidden="true"></i> Neaktivan</a>
                                        </li>
                                    </ul>
                                </div>
                            </td>
                ...
                @else
                    <tr>
                        <td colspan="9">Nema podataka za prikaz. Molimo filtrirajte za pomoć </td>
                    </tr>
                @endif
                </tbody>
            </table>
