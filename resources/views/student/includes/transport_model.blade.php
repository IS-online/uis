        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="box-body">
                    ...
                    <button type="submit" class="btn cfees save_button btn-success" id="renew-btn" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"> <i class="fa fa-car" aria-hidden="true"></i> Pridruži transport </button>
                </div>
            </div>
        </div>
        {!! Form::close() !!}
