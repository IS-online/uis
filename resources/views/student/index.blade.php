            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (data.error) {
                        ...
                        $('.room_select').html('').append('<option value="0">Odaberi sobu...</option>');
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (data.error) {
                        ...
                        $('.bed_select').html('').append('<option value="0">Odaberi krevet...</option>');
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (data.error) {
                        ...
                        $('.vehicle_select').html('').append('<option value="0">Odaberi vozilo...</option>');
