                                                ...
                                                <div class=row">
                                                    <div class="table-responsive">
                                                        <table width="100%" class="table table-bordered">
                                                            <thead>
                                                            <tr>
                                                                <th rowspan="2" class="text-center">R.B.</th>
                                                                <th rowspan="2" class="text-center">KOD PREDMETA</th>
                                                                <th rowspan="2" class="text-center">PREDMET</th>
                                                                <th colspan="2" class="text-center">MAX BOD</th>
                                                                <th colspan="2" class="text-center">PROLAZ BOD</th>
                                                                <th colspan="2" class="text-center">DOBIJENO BOD</th>
                                                                <th rowspan="2" class="text-center">UKUPNO</th>
                                                                <th rowspan="2" class="text-center">NAPOMENA</th>
                                                            </tr>
                                                            <tr>
                                                                <th>TH</th>
                                                                <th>PH</th>
                                                            ...
                                                            <td colspan="9" class="text-right">UKUPNO</td>
                                                            ...
                                                            <td>
                                                                ...
                                                                @endif
                                                                <br>
                                                                Pozicija : {{ ViewHelper::getStudentPositionInExam($examScore[0]->years_id, $examScore[0]->months_id, $examScore[0]->exams_id,$examScore[0]->faculty_id, $examScore[0]->semesters_id, $data['student']->id) }}
                                                            </td>
                                                            </tfoot>
                                                        </table>
