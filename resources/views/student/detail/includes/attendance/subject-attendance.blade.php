<div class="row">
    <div class="col-xs-12">
        <h4 class="header large lighter blue"><i class="fa fa-list" aria-hidden="true"></i>&nbsp;Detalji o prisustvu</h4>
        ...
        <div class="table-responsive">
            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                ...
                @else
                    <tr>
                        <td colspan="47"  class="align-left">Nisu pronađeni detalji o prisustvu.</td>
                    </tr>
                @endif
                </tbody>
            </table>
