...
<div class="row">
    ...
    {{--create--}}
    <div class="col-xs-12">
        <h4 class="header large lighter blue"><i class="fa fa-key" aria-hidden="true"></i>&nbsp;Kreirajte prijavu studenta</h4>
        ...
        {!! Form::open(['route' => 'student.user.create', 'method' => 'POST', 'class' => 'form-horizontal',
            ...
            <div class="form-group">
                ...
                {!! Form::label('confirmPassword', 'Potvrdite Password', ['class' => 'col-sm-2 control-label']) !!}
                <div class="col-sm-4">
    ...
    {{--edit--}}
    <div class="col-xs-12">
        <h4 class="header large lighter blue"><i class="fa fa-key" aria-hidden="true"></i>&nbsp;Izmjnite pristupne podatke studenta</h4>
        <a href="{{ route('student.user.active', ['id' => $data['student_login']->id]) }}" title="Active" class="btn-success btn-sm"><i class="fa fa-unlock-alt" aria-hidden="true"></i> Otključaj korisnika</a>
        <a href="{{ route('student.user.in-active', ['id' => $data['student_login']->id]) }}" title="In-Active" class="btn-warning btn-sm"><i class="fa fa-lock" aria-hidden="true"></i> Zaključaj korisnika</a>
        <a href="{{ route('student.user.delete', ['id' => $data['student_login']->id]) }}" title="Delete" class="btn-danger btn-sm"><i class="fa fa-trash" aria-hidden="true"></i> Izbriši korisnika</a>
        <div class="hr hr-24"></div>
        ...
        <div class="col-sm-4">
            <label data-toggle="dropdown" class="label {{ $data['student_login']->status == 'active'?"label-success":"label-danger" }}" >
                {{ $data['student_login']->status == 'active'?"Korisnik aktivan":"Korisnik zaključan" }}
            </label>
        </div>
...
<div class="row">
    ...
    @if( !$data['guardian_login'])
        {{--create--}}
        <div class="col-xs-12">
            <h4 class="header large lighter blue"><i class="fa fa-key" aria-hidden="true"></i>&nbsp;Kreirajte pristup za prijavu za mentoru</h4>
    ...
    @else
        {{--edit--}}
        <div class="col-xs-12">
            <h4 class="header large lighter blue"><i class="fa fa-key" aria-hidden="true"></i>&nbsp;Izmjenite prijavu za mentora</h4>
            ...
            <div class="col-sm-4">
                <label data-toggle="dropdown" class="label {{ $data['guardian_login']->status == 'active'?"label-success":"label-danger" }}" >
                    {{ $data['guardian_login']->status == 'active'?"Korisnik je aktivan":"Korisnik je zaključan" }}
                </label>
            </div>
            <div class="clearfix hr-8"></div>
