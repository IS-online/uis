<div class="row">
    <div class="col-xs-12">
        <h4 class="header large lighter blue"><i class="fa fa-list" aria-hidden="true"></i> Statusna lista biblioteke</h4>
        <div class="clearfix easy-link-menu">
            <span>
                @if($data['lib_member'])
                    <a class="btn-primary btn-sm" href="{{ route('library.student.view', ['id' => $data['lib_member']->member_id]) }}">
                         <i class="fa fa-calculator" aria-hidden="true"></i> Status biblioteke
                    </a>
                @endif
            </span>
        </div>
        ...
        <div class="table-responsive">
            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                ...
                @else
                    <tr>
                        <td colspan="10">Istorija izdanih knjiga nije pronađena.</td>
                        </td>
                    </tr>
                @endif
                </tbody>
