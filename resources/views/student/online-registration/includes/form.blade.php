<div class="tabbable">
    <ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="myTab4">
        <li class="active" id="generalInfoTab">
            <a data-toggle="tab" href="#generalInfo"><i class="fa fa-user bigger-110"></i> Opšte informacije</a>
        </li>
        <li id="academicInfoTab">
            <a data-toggle="tab" href="#academicInfo"><i class="fa fa-certificate bigger-110"></i> Akademski Info</a>
        </li>
        <li id="profileImageTab">
            <a data-toggle="tab" href="#profileImage"><i class="fa fa-image bigger-110"></i> Profilne slike</a>
        </li>
        @if($data['registration_setting']->rules_status == '1' || $data['registration_setting']->agreement_status == '1')
        <li id="ruleAgreementTab">
            <a data-toggle="tab" href="#ruleAgreement"><i class="fa fa-certificate bigger-110"></i> Pravila & Sporazum</a>
        </li>
        @endif
    </ul>
        ...
        <div id="generalInfo" class="tab-pane active">
            ...
            <div class="text-right">
                <a class=" btn btn-info" data-toggle="tab" href="#academicInfo" onclick="activeAcademicInfo()">
                    Dalje <i class="fa fa-arrow-circle-right bigger-110"></i>
                </a>
            </div>
        </div>
        ...
        <div id="academicInfo" class="tab-pane">
            ...
            <div class="text-right">
                <a class="btn btn-primary" data-toggle="tab" href="#generalInfo" onclick="activeGeneralInfo()">
                    <i class="fa fa-arrow-circle-left bigger-110"></i> Nazad
                </a>
