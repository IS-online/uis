...
<div class="form-group">
    {!! Form::label('student_main_image', 'Profilna slika studenta', ['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-6">
...
<div class="form-group">
    {!! Form::label('student_signature_main_image', 'Potpis studenta', ['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-6">
...
<div class="form-group">
    {!! Form::label('father_main_image', 'Očeva slika', ['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-6">
...
<div class="form-group">
    {!! Form::label('mother_main_image', 'Majkina slika', ['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-6">
...
<div class="form-group">
    {!! Form::label('guardian_main_image', 'Mentorova slika', ['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-6">
