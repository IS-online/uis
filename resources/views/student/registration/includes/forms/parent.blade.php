<h4 class="header large lighter blue"><i class="ace-icon glyphicon glyphicon-plus"></i>&nbsp;Roditelji Info</h4>

<div class="label label-warning arrowed-in arrowed-right arrowed">Informacije o djedu</div>
<hr class="hr-8">
<div class="form-group">
    {!! Form::label('grandfather_name', 'IME I PREZIME DJEDA', ['class' => 'col-sm-3 control-label']) !!}
    <div class="col-sm-3">
...
<div class="label label-warning arrowed-in arrowed-right arrowed">Detalji o ocu</div>
<hr class="hr-8">

<div class="form-group">
    {!! Form::label('father_name', 'IME OCA', ['class' => 'col-sm-3 control-label']) !!}
    <div class="col-sm-3">
...
<div class="form-group">
    {!! Form::label('father_eligibility', 'Kvalifikacija', ['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-4">
    ...
    {!! Form::label('father_occupation', 'Zanimanje', ['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-4">
...
<div class="form-group">
    {!! Form::label('father_office', 'Kancelarija', ['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-4">
    ...
    {!! Form::label('father_office_number', 'Kancelarija br.', ['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-4">
...
<div class="form-group">
    {!! Form::label('father_residence_number', 'Sjedište', ['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-4">
    ...
    {!! Form::label('father_mobile_1', 'Mobilni 1', ['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-4">
...
<div class="form-group">
    {!! Form::label('father_mobile_2', 'Mobilni 2', ['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-4">
...
<div class="label label-warning arrowed-in arrowed-right arrowed">Detalji majka</div>
<hr class="hr-8">

<div class="form-group">
    {!! Form::label('mother_name', 'IME MAJKE', ['class' => 'col-sm-3 control-label']) !!}
    <div class="col-sm-3">
...
<div class="form-group">
    {!! Form::label('mother_eligibility', 'Kvalifikacija', ['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-4">
    ...
    {!! Form::label('mother_occupation', 'Zanimanje', ['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-4">
...
<div class="form-group">
    {!! Form::label('mother_office', 'Kancelarija', ['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-4">
    ...
    {!! Form::label('mother_office_number', 'Kancelarija br.', ['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-4">
...
<div class="form-group">
    {!! Form::label('mother_residence_number', 'Sjedište', ['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-4">
    ...
    {!! Form::label('mother_mobile_1', 'Mobitel 1', ['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-4">
...
<div class="form-group">
    {!! Form::label('mother_mobile_2', 'Mobitel 2', ['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-4">
...
<div id="guardian-detail">
    ...
    <div class="form-group">
        ...
        {!! Form::label('guardian_office_number', 'Kancelarija br', ['class' => 'col-sm-2 control-label']) !!}
        <div class="col-sm-4">
    ...
    <div class="form-group">
        {!! Form::label('guardian_residence_number', 'Sjeditše', ['class' => 'col-sm-2 control-label']) !!}
        <div class="col-sm-4">
    ...
    <div class="form-group">
        ...
        {!! Form::label('guardian_address', 'Adresa mentora', ['class' => 'col-sm-2 control-label']) !!}
        <div class="col-sm-4">
...
<div id="link-guardian-detail">
    <div class="form-group">
        {!! Form::label('guardian_info', 'Pronađite Guardiana koristeći ime | Broj mobilnog telefona | emaila i kliknite na vezu. ', ['class' => 'col-sm-12 control-label align-center']) !!}
        <div class="col-sm-12">
            {!! Form::select('guardian_link_id', [], null, ["placeholder" => "Unesite Student Reg.br. ili Ime mentora...", "class" => "col-xs-12 col-sm-12", "style" => "width: 100%;"]) !!}
            ...
            <div class="align-right">
                <button type="button" class="btn btn-sm btn-primary" id="load-guardian-html-btn">
                    <i class="fa fa-link bigger-120"></i> Poveži
                </button>
            </div>
        </div>
    </div>
