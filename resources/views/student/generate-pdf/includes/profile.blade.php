                    ...
                    <ul class="align-left dropdown-menu dropdown-caret dropdown-lighter">
                        ...
                        <li>
                            <a href="#">
                                ...
                                &nbsp;
                                <span class="grey">Nevidljiv</span>
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="profile-user-info profile-user-info-striped">
            ...
            <div class="profile-info-row">
                ...
                @if($data['student']->reg_date !="")
                    <div class="profile-info-name"> Datum reg. :</div>
                    <div class="profile-info-value">
    ...
    <div class="profile-user-info profile-user-info-striped">
        <div class="profile-info-row">
            @if($data['student']->guardian_first_name !="")
                <div class="profile-info-name"> Ime mentora :  </div>
                <div class="profile-info-value">
...
<div class="row">
    @if (isset($data['academicInfos']) && $data['academicInfos']->count() > 0)
        ...
        <h3 class="text-uppercase text-center no-margin-top" style="font-family: 'Righteous', cursive; font-size: 16px">AKADEMSKE KVALIFIKACIJE</h3>
        <div class="space-6"></div>
