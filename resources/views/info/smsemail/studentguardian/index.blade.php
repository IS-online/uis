    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#group-message-send-btn').click(function () {
                ...
                if($sms || $email){
                    if($sms && message < 8){
                        toastr.info("Poruka mora imati najmanje 8 znakova za SMS", "Info:");
                        return false;
                    }

                    if($email && subject === ''){
                        toastr.info("Predmet je obavezan za e-mail", "Info:");
                        return false;
                    }
                    ...
                    if($student || $guardian || $father || $mother){
                        ...
                        if ($chkCount <= 0) {
                            toastr.info("Molimo, odaberite barem jednog Studenta.", "Info:");
                            return false;
                        }
           ...
           $.ajax({
               ...
               success: function (response) {
                   ...
                   if (data.error) {
                       ...
                       $('.semester_select').html('').append('<option value="0">Odaberi Sem./Sec.</option>');
