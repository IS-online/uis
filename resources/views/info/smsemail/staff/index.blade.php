        ...
        $(document).ready(function () {
            ...
            $('#group-message-send-btn').click(function () {
                ...
                if($sms || $email){
                    ...
                    if($email && subject === ''){
                        toastr.info("Nedostaje predmet", "Info:");
                        return false;
                    }

                    if($email && emailMessage < 12){
                        toastr.info("Poruka mora imati najmanje 12 znakova ako je SMS", "Info:");
                        return false;
                    }
                    ...
                    if ($chkCount <= 0) {
                        toastr.info("Odaberite najmanje jednog uposlenika.", "Info:");
                        return false;
                    }
