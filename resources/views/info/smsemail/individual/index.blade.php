        ...
        $(document).ready(function () {
            ...
            $('#individual-message-send-btn').click(function () {
                ...
                if($sms || $email){
                    ...
                    if($sms && number === ''){
                        toastr.info("Molimo Vas da popunite barem jedan kontakt broj", "Info:");
                        return false;
                    }

                    if($sms && message < 8){
                        toastr.info("Poruka mora imati više od 8 znakova. Kada je cilj SMS", "Info:");
                        return false;
                    }

                    if($email && email === ''){
                        toastr.info("Molimo da unesete najmanje jedan e-mail", "Info:");
                        return false;
                    }

                    if($email && subject === ''){
                        toastr.info("Predmet je obavezan. Kada se šalje Email", "Info:");
                        return false;
                    }

                    if($email && emailMessage < 12){
                        toastr.info("Poruka mora imati više od 12 znakova kada se šalje SMS", "Info:");
                        return false;
                    }
