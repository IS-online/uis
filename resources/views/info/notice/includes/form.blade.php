...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group">
            {!! Form::label('publish_date', 'Datum objave', ['class' => 'col-sm-4 control-label']) !!}
            <div class="col-sm-8">
        ...
        <div class="form-group">
            {!! Form::label('end_date', 'Datum završetka', ['class' => 'col-sm-4 control-label']) !!}
            <div class="col-sm-8">
        ...
        @if(isset($data['roles']) && $data['roles']->count() > 0)
            <span class="label label-warning arrowed-right arrowed-in">Grupe za prikaz poruka</span>
            <div class="form-group">
                <div class="checkbox">
