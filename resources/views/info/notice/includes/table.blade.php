                        ...
                        <div class="group">
                            ...
                            <div class="ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom" id="ui-id-24" aria-labelledby="ui-id-23" role="tabpanel" style="display: none;" aria-hidden="true">
                                ...
                                <div class="align-right" style="font-weight: 600">
                                    ...
                                    <hr class="hr-10">
                                    <a class="btn-primary btn-sm" href="{{ route($base_route.'.edit', ['id' => $row->id]) }}"><i class="fa fa-pencil" aria-hidden="true"></i>&nbsp;Izmjena</a>
                                    <a class="btn-danger btn-sm bootbox-confirm" href="{{ route($base_route.'.delete', ['id' => $row->id]) }}"><i class="fa fa-trash" aria-hidden="true"></i>&nbsp;Brisanje</a>
