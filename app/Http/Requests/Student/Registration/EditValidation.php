...
class EditValidation extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'pass_year.*'                     => 'max:4',
            'symbol_no.*'                     => 'max:25',
            'division_grade.*'                => 'max:30',
            'major_subjects.*'                => 'max:50',

            'student_main_image'            => 'mimes:jpg,jpeg,bmp,png',
            'student_signature_main_image'  => 'mimes:jpg,jpeg,bmp,png',
            'father_main_image'             => 'mimes:jpg,jpeg,bmp,png',
            'mother_main_image'             => 'mimes:jpg,jpeg,bmp,png',
            'guardian_main_image'           => 'mimes:jpg,jpeg,bmp,png',
        ];
    ...
    {
        return [
            'reg_no.unique'                  => 'Unesite jedinstveni reg.br.',
