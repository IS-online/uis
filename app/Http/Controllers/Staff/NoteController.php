...
class NoteController extends CollegeBaseController
{
    ...
    protected $panel = 'Napomene za uspolenika';
    ...
    public function store(AddValidation $request)
    {
        ...
        if (!$staff)
            return redirect()->route('staff.note')->with('message_warning', 'Molimo provjerite registracijski broj. 
            Ovaj registarski broj nije važeći registarski broj uposlnika.');
        ...
        $request->session()->flash($this->message_success, $this->panel. ' Kreiranje uspješno.');
    ...
    public function update(EditValidation $request, $id)
    {
        ...
        if (!$staff)
            return redirect()->route('staff.note')->with('message_warning', 'Molimo provjerite registracijski broj. 
            Ovaj registarski broj nije važeći registarski broj uposlenika.');
