...
class DesignationController extends CollegeBaseController
{
    ...
    {
        $data = [];
        $data['designation'] = StaffDesignation::select('id', 'title', 'status')->orderBy('id')->get();
    ...
    public function inActive(request $request, $id)
    {
        ...
        $request->session()->flash($this->message_success, $row->semester.' '.$this->panel.' Uspješno neaktivan.');
        return redirect()->route($this->base_route);
    }
}