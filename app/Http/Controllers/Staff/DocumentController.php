...
class DocumentController extends CollegeBaseController
{
    ...
    protected $panel = 'dokument uposlenika';
    ...
    public function store(AddValidation $request)
    {
        ...
        if (!$staff)
            return redirect()->route('student.document')->with('message_warning', 'Molimo provjerite registarski broj uposlenika. Ovaj registarski broj nije važeća registracija uposlenika.');
        ...
        $request->session()->flash($this->message_success, $this->panel. ' Prenos uspješan.');
        ...
        if ($request->has('bulk_action') && in_array($request->get('bulk_action'), ['active', 'in-active', 'delete'])) {
            ...
            if ($request->has('chkIds')) {
                ...
                if ($request->get('bulk_action') == 'active' || $request->get('bulk_action') == 'in-active')
                    $request->session()->flash($this->message_success, $request->get('bulk_action'). ' Akcija uspješno.');
                else
