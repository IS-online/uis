    ...
    public function store(AddValidation $request)
    {
        ...
        if($data){
            ...
            if(!$currentMember){
                ...
                $request->session()->flash($this->message_warning,'Član je već registrovan. Molimo pronađite i uredite.');
                return back();
            }
        }else{
            $request->session()->flash($this->message_warning,'Registracijski broj ili tip korisnika nisu važeći.');
        }
