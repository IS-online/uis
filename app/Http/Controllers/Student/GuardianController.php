...
class GuardianController extends CollegeBaseController
{
    ...
    public function register(AddValidation $request)
    {
        ...
        $request->session()->flash($this->message_success, $this->panel. ' Uspješno kreiran.');
    ...
    public function update(EditValidation $request, $id)
    {
       ...
       $guardian_image_name = isset($guardian_image_name)?$guardian_image_name:$row->guardian_image;
        ...
        $request->session()->flash($this->message_success, $this->panel. ' Info apdated uspješan.');
        return back();
    ...
    public function link(request $request)
    {
        ...
        $request->session()->flash($this->message_success, 'Linkovanje studenta uspješno.');
        return back();
    }
    ...
    public function unlink(request $request, $student,$guardian)
    {
        ...
        $request->session()->flash($this->message_success, 'Raskidanje linka uspješno.');
        return back();
    }
