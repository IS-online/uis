...
class HomeController extends CollegeBaseController
{
    ...
    public function index()
    {
        ...
        $data['student'] = Student::select('students.id','students.reg_no', 'students.reg_date', 'students.university_reg',
            ...
            'students.mother_tongue', 'students.email', 'students.extra_info', 'students.student_image', 'students.status', 'students.mjesto_rodjenja',
            'students.drzava_rodjenja', 'students.opstina_rodjenja', 'students.broj_dosijea', 'students.nacionalnost', 
            'students.status_studenta', 'students.promjena_prezimena_imena', 'students.dolazak_sa_druge_vsu', 'students.nostrifikacija',
        ...
        if (!$data['student']){
            request()->session()->flash($this->message_warning, "Student nije validan");
    ...
    public function profile()
    {
        ...
        $data['student'] = Student::select('students.id','students.reg_no', 'students.reg_date', 'students.university_reg',
            ...
            'pd.grandfather_first_name', 'students.promjena_prezimena_imena', 'students.dolazak_sa_druge_vsu', 'students.nostrifikacija',
            'students.datum_ispisa', 'students.promjene_studija', 'students.pohvale_nagrade', 'students.mjere', 'students.datum_zavrsetka_studija',
    ...
    public function editProfile(Request $request, $id)
    {
        ...
        $data['row'] = Student::select('students.id','students.reg_no', 'students.reg_date', 'students.university_reg',
            ...
            'students.mjesto_rodjenja', 'students.drzava_rodjenja', 'students.opstina_rodjenja', 'students.broj_dosijea', 'students.nacionalnost',
            'students.status_studenta', 'students.promjena_prezimena_imena', 'students.dolazak_sa_druge_vsu', 'students.nostrifikacija',
            'students.datum_ispisa', 'students.promjene_studija', 'students.pohvale_nagrade', 'students.mjere', 'students.datum_zavrsetka_studija',
    ...
    public function password(Request $request, $id)
    {
        ...
        if($request->password != $request->confirmPassword){
            $request->session()->flash($this->message_warning, 'Lozinke u oba polja moraju biti identične');
        ...
        $request->session()->flash($this->message_success, 'Prijava ažurirana.');
        return redirect()->back();
    }
    ...
    public function checkSubmitTimeLimitation($request, $assignment){
       ...
       if($assignment->end_date <= $currentDate){
           $request->session()->flash($this->message_warning, 'Ne možete poslati odgovor zbog vremenskog ograničenja ');
           return false;
      }else{
          return true;
      }
