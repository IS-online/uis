...
class Student extends BaseModel
{
    protected $fillable = ['created_by', 'last_updated_by', 'reg_no', 'reg_date', 'university_reg','faculty','semester','batch',
        ...
        'religion', 'caste','mother_tongue', 'email', 'extra_info', 'student_image','student_signature','status', 'mjesto_rodjenja', 'drzava_rodjenja', 'opstina_rodjenja',
        'broj_dosijea', 'nacionalnost', 'status_studenta', 'promjena_prezimena_imena', 'dolazak_sa_druge_vsu', 'nostrifikacija', 'datum_ispisa',
        'promjene_studija', 'pohvale_nagrade', 'mjere', 'datum_zavrsetka_studija'];
